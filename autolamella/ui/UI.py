...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayoutWidget.setGeometry(QtCore.QRect(0, 140, 321, 313))
        ...
        self.stage_rotation = QtWidgets.QLineEdit(self.formLayoutWidget)
        ...
        self.stage_tilt = QtWidgets.QLineEdit(self.formLayoutWidget)
        ...
        self.beamshift_attempts = QtWidgets.QLineEdit(self.formLayoutWidget)
        ...
        self.formLayout.setWidget(4, QtWidgets.QFormLayout.LabelRole, self.lengthLabel)
        self.fiducial_length = QtWidgets.QLineEdit(self.formLayoutWidget)
        self.fiducial_length.setObjectName("fiducial_length")
        self.formLayout.setWidget(4, QtWidgets.QFormLayout.FieldRole, self.fiducial_length)
        self.widthLabel = QtWidgets.QLabel(self.formLayoutWidget)
        self.widthLabel.setObjectName("widthLabel")
        self.formLayout.setWidget(5, QtWidgets.QFormLayout.LabelRole, self.widthLabel)
        self.width_fiducial = QtWidgets.QLineEdit(self.formLayoutWidget)
        self.width_fiducial.setObjectName("width_fiducial")
        self.formLayout.setWidget(5, QtWidgets.QFormLayout.FieldRole, self.width_fiducial)
        self.depthLabel = QtWidgets.QLabel(self.formLayoutWidget)
        self.depthLabel.setObjectName("depthLabel")
        self.formLayout.setWidget(6, QtWidgets.QFormLayout.LabelRole, self.depthLabel)
        self.depth_fiducial = QtWidgets.QLineEdit(self.formLayoutWidget)
        self.depth_fiducial.setObjectName("depth_fiducial")
        self.formLayout.setWidget(6, QtWidgets.QFormLayout.FieldRole, self.depth_fiducial)
        ...
        self.formLayout.setWidget(7, QtWidgets.QFormLayout.LabelRole, self.millingCurrentLabel)
        self.current_fiducial = QtWidgets.QLineEdit(self.formLayoutWidget)
        self.current_fiducial.setObjectName("current_fiducial")
        self.formLayout.setWidget(7, QtWidgets.QFormLayout.FieldRole, self.current_fiducial)
        ...
        self.formLayout.setWidget(8, QtWidgets.QFormLayout.SpanningRole, self.label_9)
        self.widthLabel_2 = QtWidgets.QLabel(self.formLayoutWidget)
        self.widthLabel_2.setObjectName("widthLabel_2")
        self.formLayout.setWidget(10, QtWidgets.QFormLayout.LabelRole, self.widthLabel_2)
        self.lamella_width = QtWidgets.QLineEdit(self.formLayoutWidget)
        self.lamella_width.setObjectName("lamella_width")
        self.formLayout.setWidget(10, QtWidgets.QFormLayout.FieldRole, self.lamella_width)
        self.heightLabel = QtWidgets.QLabel(self.formLayoutWidget)
        self.heightLabel.setObjectName("heightLabel")
        self.formLayout.setWidget(11, QtWidgets.QFormLayout.LabelRole, self.heightLabel)
        self.lamella_height = QtWidgets.QLineEdit(self.formLayoutWidget)
        self.lamella_height.setObjectName("lamella_height")
        self.formLayout.setWidget(11, QtWidgets.QFormLayout.FieldRole, self.lamella_height)
        self.trenchHeightLabel = QtWidgets.QLabel(self.formLayoutWidget)
        self.trenchHeightLabel.setObjectName("trenchHeightLabel")
        self.formLayout.setWidget(12, QtWidgets.QFormLayout.LabelRole, self.trenchHeightLabel)
        self.trench_height = QtWidgets.QLineEdit(self.formLayoutWidget)
        self.trench_height.setObjectName("trench_height")
        self.formLayout.setWidget(12, QtWidgets.QFormLayout.FieldRole, self.trench_height)
        self.millingDepthLabel = QtWidgets.QLabel(self.formLayoutWidget)
        self.millingDepthLabel.setObjectName("millingDepthLabel")
        self.formLayout.setWidget(13, QtWidgets.QFormLayout.LabelRole, self.millingDepthLabel)
        self.depth_trench = QtWidgets.QLineEdit(self.formLayoutWidget)
        self.depth_trench.setObjectName("depth_trench")
        self.formLayout.setWidget(13, QtWidgets.QFormLayout.FieldRole, self.depth_trench)
        self.offsetLabel = QtWidgets.QLabel(self.formLayoutWidget)
        self.offsetLabel.setObjectName("offsetLabel")
        self.formLayout.setWidget(14, QtWidgets.QFormLayout.LabelRole, self.offsetLabel)
        self.offset = QtWidgets.QLineEdit(self.formLayoutWidget)
        self.offset.setObjectName("offset")
        self.formLayout.setWidget(14, QtWidgets.QFormLayout.FieldRole, self.offset)
        self.sizeRatioLabel = QtWidgets.QLabel(self.formLayoutWidget)
        self.sizeRatioLabel.setObjectName("sizeRatioLabel")
        self.formLayout.setWidget(15, QtWidgets.QFormLayout.LabelRole, self.sizeRatioLabel)
        self.size_ratio = QtWidgets.QLineEdit(self.formLayoutWidget)
        self.size_ratio.setObjectName("size_ratio")
        self.formLayout.setWidget(15, QtWidgets.QFormLayout.FieldRole, self.size_ratio)
        ...
        self.formLayout.setWidget(16, QtWidgets.QFormLayout.LabelRole, self.millingCurrentLabel_2)
        self.current_lamella = QtWidgets.QLineEdit(self.formLayoutWidget)
        self.current_lamella.setObjectName("current_lamella")
        self.formLayout.setWidget(16, QtWidgets.QFormLayout.FieldRole, self.current_lamella)
        self.stageLabel = QtWidgets.QLabel(self.formLayoutWidget)
        self.stageLabel.setObjectName("stageLabel")
        self.formLayout.setWidget(9, QtWidgets.QFormLayout.LabelRole, self.stageLabel)
        ...
        self.stage_lamella.addItem("")
        self.stage_lamella.addItem("")
        self.formLayout.setWidget(9, QtWidgets.QFormLayout.FieldRole, self.stage_lamella)
        self.widthLabel_3 = QtWidgets.QLabel(self.formLayoutWidget)
        self.widthLabel_3.setObjectName("widthLabel_3")
        self.formLayout.setWidget(18, QtWidgets.QFormLayout.LabelRole, self.widthLabel_3)
        self.micro_exp_width = QtWidgets.QLineEdit(self.formLayoutWidget)
        self.micro_exp_width.setObjectName("micro_exp_width")
        self.formLayout.setWidget(18, QtWidgets.QFormLayout.FieldRole, self.micro_exp_width)
        self.heightLabel_2 = QtWidgets.QLabel(self.formLayoutWidget)
        self.heightLabel_2.setObjectName("heightLabel_2")
        self.formLayout.setWidget(19, QtWidgets.QFormLayout.LabelRole, self.heightLabel_2)
        self.micro_exp_height = QtWidgets.QLineEdit(self.formLayoutWidget)
        self.micro_exp_height.setObjectName("micro_exp_height")
        self.formLayout.setWidget(19, QtWidgets.QFormLayout.FieldRole, self.micro_exp_height)
        self.distanceLabel = QtWidgets.QLabel(self.formLayoutWidget)
        self.distanceLabel.setObjectName("distanceLabel")
        self.formLayout.setWidget(20, QtWidgets.QFormLayout.LabelRole, self.distanceLabel)
        self.micro_exp_distance = QtWidgets.QLineEdit(self.formLayoutWidget)
        self.micro_exp_distance.setObjectName("micro_exp_distance")
        self.formLayout.setWidget(20, QtWidgets.QFormLayout.FieldRole, self.micro_exp_distance)
        self.export_protocol = QtWidgets.QPushButton(self.formLayoutWidget)
        self.export_protocol.setObjectName("export_protocol")
        self.formLayout.setWidget(21, QtWidgets.QFormLayout.FieldRole, self.export_protocol)
        ...
        self.formLayout.setWidget(17, QtWidgets.QFormLayout.SpanningRole, self.label_10)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.millingCurrentLabel.setText(_translate("MainWindow", "Milling current"))
        self.label_9.setText(_translate("MainWindow", "Lamella Parameters "))
        self.widthLabel_2.setText(_translate("MainWindow", "Lamella width"))
        self.heightLabel.setText(_translate("MainWindow", "Lamella height"))
        self.trenchHeightLabel.setText(_translate("MainWindow", "Trench height"))
        self.millingDepthLabel.setText(_translate("MainWindow", "Milling depth"))
        self.offsetLabel.setText(_translate("MainWindow", "Offset"))
        self.sizeRatioLabel.setText(_translate("MainWindow", "Size ratio"))
        self.millingCurrentLabel_2.setText(_translate("MainWindow", "Milling current"))
        ...
        self.widthLabel_3.setText(_translate("MainWindow", "Width"))
