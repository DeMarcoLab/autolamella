...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.formLayout.setWidget(0, QtWidgets.QFormLayout.SpanningRole, self.log_txt)
        self.tabWidget_2.addTab(self.tab_3, "")
        self.tab_5 = QtWidgets.QWidget()
        self.tab_5.setObjectName("tab_5")
        self.gridLayout = QtWidgets.QGridLayout(self.tab_5)
        self.gridLayout.setObjectName("gridLayout")
        self.instructions_textEdit = QtWidgets.QPlainTextEdit(self.tab_5)
        font = QtGui.QFont()
        ...
        self.gridLayout.addWidget(self.instructions_textEdit, 0, 0, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.save_button, 9, 0, 1, 2)
        ...
        self.comboBox_moving_pattern.addItem("")
        self.gridLayout_3.addWidget(self.comboBox_moving_pattern, 7, 1, 1, 1)
        self.label_2 = QtWidgets.QLabel(self.tab)
        self.label_2.setObjectName("label_2")
        self.gridLayout_3.addWidget(self.label_2, 8, 0, 1, 2)
        ...
        self.gridLayout_3.addWidget(self.add_button, 4, 0, 1, 1)
        self.remove_button = QtWidgets.QPushButton(self.tab)
        self.remove_button.setStyleSheet("")
        self.remove_button.setObjectName("remove_button")
        self.gridLayout_3.addWidget(self.remove_button, 4, 1, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.lamella_index, 5, 1, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.run_button, 13, 0, 1, 2)
        ...
        self.gridLayout_3.addWidget(self.go_to_lamella, 10, 0, 1, 2)
        ...
        self.actionImport_Positions = QtWidgets.QAction(MainWindow)
        self.actionImport_Positions.setObjectName("actionImport_Positions")
        ...
        self.menuAutoLamella.addAction(self.actionImport_Positions)
...
""))
        ...
        self.actionImport_Positions.setText(_translate("MainWindow", "Import Positions"))
