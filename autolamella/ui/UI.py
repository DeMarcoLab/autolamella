...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.verticalLayoutWidget_2.setGeometry(QtCore.QRect(0, 640, 441, 131))
        ...
        self.gridLayoutWidget_2.setGeometry(QtCore.QRect(0, 10, 391, 69))
        ...
        self.protocol_txt.setAlignment(QtCore.Qt.AlignCenter)
        self.protocol_txt.setObjectName("protocol_txt")
        self.gridLayout_2.addWidget(self.protocol_txt, 1, 1, 1, 1)
        self.tabWidget_2 = QtWidgets.QTabWidget(self.tab)
        self.tabWidget_2.setGeometry(QtCore.QRect(0, 80, 431, 511))
        self.tabWidget_2.setObjectName("tabWidget_2")
        self.tab_experiment = QtWidgets.QWidget()
        self.tab_experiment.setObjectName("tab_experiment")
        self.gridLayoutWidget = QtWidgets.QWidget(self.tab_experiment)
        self.gridLayoutWidget.setGeometry(QtCore.QRect(0, 0, 417, 344))
        ...
        self.gridLayout.addWidget(self.move_fiducial_button, 12, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.remill_fiducial, 15, 0, 1, 2)
        ...
        self.gridLayout.addWidget(self.show_lamella, 4, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.go_to_lamella, 11, 0, 1, 2)
        ...
        self.gridLayout.addWidget(self.run_button, 18, 0, 1, 2)
        ...
        self.gridLayout.addWidget(self.microexpansionCheckBox, 4, 1, 1, 1)
        self.save_button = QtWidgets.QPushButton(self.gridLayoutWidget)
        self.save_button.setObjectName("save_button")
        self.gridLayout.addWidget(self.save_button, 13, 0, 1, 2)
        ...
        self.lamella_count_txt.setAlignment(QtCore.Qt.AlignCenter)
        self.lamella_count_txt.setObjectName("lamella_count_txt")
        self.gridLayout.addWidget(self.lamella_count_txt, 14, 0, 1, 2)
        ...
        self.gridLayout.addWidget(self.move_lamella_button, 12, 0, 1, 1)
        self.remove_button = QtWidgets.QPushButton(self.gridLayoutWidget)
        self.remove_button.setObjectName("remove_button")
        self.gridLayout.addWidget(self.remove_button, 7, 0, 1, 2)
        self.tabWidget_2.addTab(self.tab_experiment, "")
        self.tab_4 = QtWidgets.QWidget()
        self.tab_4.setObjectName("tab_4")
        self.gridLayoutWidget_5 = QtWidgets.QWidget(self.tab_4)
        self.gridLayoutWidget_5.setGeometry(QtCore.QRect(0, 0, 421, 471))
        self.gridLayoutWidget_5.setObjectName("gridLayoutWidget_5")
        self.gridLayout_system = QtWidgets.QGridLayout(self.gridLayoutWidget_5)
        self.gridLayout_system.setContentsMargins(0, 0, 0, 0)
        self.gridLayout_system.setObjectName("gridLayout_system")
        self.tabWidget_2.addTab(self.tab_4, "")
        self.tabWidget.addTab(self.tab, "")
        self.instructions_tab = QtWidgets.QWidget()
        self.instructions_tab.setObjectName("instructions_tab")
        self.verticalLayoutWidget = QtWidgets.QWidget(self.instructions_tab)
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(10, 20, 421, 271))
        ...
        self.presetLabel_2 = QtWidgets.QLabel(self.formLayoutWidget)
        self.presetLabel_2.setObjectName("presetLabel_2")
        self.formLayout.setWidget(9, QtWidgets.QFormLayout.LabelRole, self.presetLabel_2)
        self.presetComboBox_fiducial = QtWidgets.QComboBox(self.formLayoutWidget)
        self.presetComboBox_fiducial.setObjectName("presetComboBox_fiducial")
        self.formLayout.setWidget(9, QtWidgets.QFormLayout.FieldRole, self.presetComboBox_fiducial)
        ...
        self.formLayout.setWidget(11, QtWidgets.QFormLayout.LabelRole, self.stageLabel)
        ...
        self.stage_lamella.addItem("")
        self.stage_lamella.addItem("")
        self.formLayout.setWidget(11, QtWidgets.QFormLayout.FieldRole, self.stage_lamella)
        self.widthLabel_2 = QtWidgets.QLabel(self.formLayoutWidget)
        self.widthLabel_2.setObjectName("widthLabel_2")
        self.formLayout.setWidget(12, QtWidgets.QFormLayout.LabelRole, self.widthLabel_2)
        ...
        self.formLayout.setWidget(12, QtWidgets.QFormLayout.FieldRole, self.lamella_width)
        self.heightLabel = QtWidgets.QLabel(self.formLayoutWidget)
        self.heightLabel.setObjectName("heightLabel")
        self.formLayout.setWidget(13, QtWidgets.QFormLayout.LabelRole, self.heightLabel)
        ...
        self.formLayout.setWidget(13, QtWidgets.QFormLayout.FieldRole, self.lamella_height)
        self.trenchHeightLabel = QtWidgets.QLabel(self.formLayoutWidget)
        self.trenchHeightLabel.setObjectName("trenchHeightLabel")
        self.formLayout.setWidget(14, QtWidgets.QFormLayout.LabelRole, self.trenchHeightLabel)
        ...
        self.formLayout.setWidget(14, QtWidgets.QFormLayout.FieldRole, self.trench_height)
        self.millingDepthLabel = QtWidgets.QLabel(self.formLayoutWidget)
        self.millingDepthLabel.setObjectName("millingDepthLabel")
        self.formLayout.setWidget(15, QtWidgets.QFormLayout.LabelRole, self.millingDepthLabel)
        ...
        self.formLayout.setWidget(18, QtWidgets.QFormLayout.LabelRole, self.millingCurrentLabel_2)
        ...
        self.formLayout.setWidget(18, QtWidgets.QFormLayout.FieldRole, self.current_lamella)
        self.presetLabel = QtWidgets.QLabel(self.formLayoutWidget)
        self.presetLabel.setObjectName("presetLabel")
        self.formLayout.setWidget(19, QtWidgets.QFormLayout.LabelRole, self.presetLabel)
        self.presetComboBox = QtWidgets.QComboBox(self.formLayoutWidget)
        self.presetComboBox.setObjectName("presetComboBox")
        self.formLayout.setWidget(19, QtWidgets.QFormLayout.FieldRole, self.presetComboBox)
        ...
        self.formLayout.setWidget(20, QtWidgets.QFormLayout.SpanningRole, self.label_10)
        self.widthLabel_3 = QtWidgets.QLabel(self.formLayoutWidget)
        self.widthLabel_3.setObjectName("widthLabel_3")
        self.formLayout.setWidget(21, QtWidgets.QFormLayout.LabelRole, self.widthLabel_3)
        ...
        self.formLayout.setWidget(21, QtWidgets.QFormLayout.FieldRole, self.micro_exp_width)
        self.heightLabel_2 = QtWidgets.QLabel(self.formLayoutWidget)
        self.heightLabel_2.setObjectName("heightLabel_2")
        self.formLayout.setWidget(22, QtWidgets.QFormLayout.LabelRole, self.heightLabel_2)
        ...
        self.formLayout.setWidget(22, QtWidgets.QFormLayout.FieldRole, self.micro_exp_height)
        self.distanceLabel = QtWidgets.QLabel(self.formLayoutWidget)
        self.distanceLabel.setObjectName("distanceLabel")
        self.formLayout.setWidget(23, QtWidgets.QFormLayout.LabelRole, self.distanceLabel)
        ...
        self.formLayout.setWidget(23, QtWidgets.QFormLayout.FieldRole, self.micro_exp_distance)
        self.export_protocol = QtWidgets.QPushButton(self.formLayoutWidget)
        self.export_protocol.setObjectName("export_protocol")
        self.formLayout.setWidget(24, QtWidgets.QFormLayout.FieldRole, self.export_protocol)
        self.application_file_label = QtWidgets.QLabel(self.formLayoutWidget)
        self.application_file_label.setObjectName("application_file_label")
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.LabelRole, self.application_file_label)
        self.comboBoxapplication_file = QtWidgets.QComboBox(self.formLayoutWidget)
        self.comboBoxapplication_file.setObjectName("comboBoxapplication_file")
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.comboBoxapplication_file)
        ...
        self.gridLayoutWidget_3.setGeometry(QtCore.QRect(0, 0, 431, 611))
        ...
        self.gridLayoutWidget_4.setGeometry(QtCore.QRect(0, 0, 431, 611))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.protocol_txt.setText(_translate("MainWindow", "PLEASE CREATE OR LOAD AN EXPERIMENT      \n"
"  AND CONNECT TO MICROSCOPE"))
        ...
        self.tabWidget_2.setTabText(self.tabWidget_2.indexOf(self.tab_experiment), _translate("MainWindow", "Experiment"))
        self.tabWidget_2.setTabText(self.tabWidget_2.indexOf(self.tab_4), _translate("MainWindow", "Microscope Setup"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab), _translate("MainWindow", "General"))
        self.label.setText(_translate("MainWindow", "Autolamella instructions:"))
        self.label_2.setText(_translate("MainWindow", "1. Create experiment (file menu) "))
        self.label_17.setText(_translate("MainWindow", "2. Take images "))
        self.label_6.setText(_translate("MainWindow", "3. Modify protocol if needed"))
        self.label_12.setText(_translate("MainWindow", "4. Add lamella"))
        self.label_13.setText(_translate("MainWindow", "5. Move to region of interest on the sample"))
        self.label_14.setText(_translate("MainWindow", "6. Adjust lamella and fiducial positions"))
        self.label_18.setText(_translate("MainWindow", "7. Save lamella"))
        self.label_19.setText(_translate("MainWindow", "8. Check fiducial milling"))
        self.label_15.setText(_translate("MainWindow", "9. Repeat 3-8 as needed"))
        self.label_16.setText(_translate("MainWindow", "10. Run autolamella"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.instructions_tab), _translate("MainWindow", "Instructions"))
