...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout_3.addItem(spacerItem3, 23, 0, 1, 2)
        ...
        self.formLayout_2.setWidget(8, QtWidgets.QFormLayout.LabelRole, self.beamShiftAttemptsLabel)
        self.beamshift_attempts = QtWidgets.QDoubleSpinBox(self.tab_2)
        self.beamshift_attempts.setObjectName("beamshift_attempts")
        self.formLayout_2.setWidget(8, QtWidgets.QFormLayout.FieldRole, self.beamshift_attempts)
        ...
        self.formLayout_2.setWidget(9, QtWidgets.QFormLayout.LabelRole, self.label_protocol_align_at)
        ...
        self.formLayout_2.setWidget(9, QtWidgets.QFormLayout.FieldRole, self.comboBox_current_alignment)
        ...
        self.formLayout_2.setWidget(10, QtWidgets.QFormLayout.LabelRole, self.label_protocol_align_with)
        ...
        self.formLayout_2.setWidget(10, QtWidgets.QFormLayout.FieldRole, self.comboBox_alignment_with)
        ...
        self.formLayout_2.setWidget(12, QtWidgets.QFormLayout.SpanningRole, self.label_ml_header)
        self.label_ml_checkpoint = QtWidgets.QLabel(self.tab_2)
        self.label_ml_checkpoint.setObjectName("label_ml_checkpoint")
        self.formLayout_2.setWidget(13, QtWidgets.QFormLayout.LabelRole, self.label_ml_checkpoint)
        ...
        self.formLayout_2.setWidget(13, QtWidgets.QFormLayout.FieldRole, self.lineEdit_ml_checkpoint)
        self.label_ml_encoder = QtWidgets.QLabel(self.tab_2)
        self.label_ml_encoder.setObjectName("label_ml_encoder")
        self.formLayout_2.setWidget(14, QtWidgets.QFormLayout.LabelRole, self.label_ml_encoder)
        self.lineEdit_ml_encoder = QtWidgets.QLineEdit(self.tab_2)
        self.lineEdit_ml_encoder.setObjectName("lineEdit_ml_encoder")
        self.formLayout_2.setWidget(14, QtWidgets.QFormLayout.FieldRole, self.lineEdit_ml_encoder)
        ...
        self.formLayout_2.setWidget(15, QtWidgets.QFormLayout.SpanningRole, self.label_supervise_header)
        self.checkBox_trench = QtWidgets.QCheckBox(self.tab_2)
        self.checkBox_trench.setObjectName("checkBox_trench")
        self.formLayout_2.setWidget(16, QtWidgets.QFormLayout.LabelRole, self.checkBox_trench)
        self.checkBox_setup = QtWidgets.QCheckBox(self.tab_2)
        self.checkBox_setup.setObjectName("checkBox_setup")
        self.formLayout_2.setWidget(16, QtWidgets.QFormLayout.FieldRole, self.checkBox_setup)
        self.checkBox_undercut = QtWidgets.QCheckBox(self.tab_2)
        self.checkBox_undercut.setObjectName("checkBox_undercut")
        self.formLayout_2.setWidget(17, QtWidgets.QFormLayout.LabelRole, self.checkBox_undercut)
        self.checkBox_features = QtWidgets.QCheckBox(self.tab_2)
        self.checkBox_features.setObjectName("checkBox_features")
        self.formLayout_2.setWidget(17, QtWidgets.QFormLayout.FieldRole, self.checkBox_features)
        ...
        self.formLayout_2.setWidget(18, QtWidgets.QFormLayout.FieldRole, self.checkBox_supervise_mill_rough)
        ...
        self.formLayout_2.setWidget(19, QtWidgets.QFormLayout.FieldRole, self.checkBox_supervise_mill_regular)
        ...
        self.formLayout_2.setWidget(20, QtWidgets.QFormLayout.FieldRole, self.checkBox_supervise_mill_polishing)
        ...
        self.formLayout_2.setWidget(23, QtWidgets.QFormLayout.SpanningRole, self.pushButton_update_protocol)
