...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout_3.addItem(spacerItem1, 17, 0, 1, 2)
        ...
        self.formLayout_2.setWidget(7, QtWidgets.QFormLayout.LabelRole, self.label_protocol_undercut_tilt_angle)
        ...
        self.formLayout_2.setWidget(7, QtWidgets.QFormLayout.FieldRole, self.doubleSpinBox_undercut_tilt)
        ...
        self.formLayout_2.setWidget(8, QtWidgets.QFormLayout.LabelRole, self.label_protocol_undercut_tilt_step)
        ...
        self.formLayout_2.setWidget(13, QtWidgets.QFormLayout.LabelRole, self.label_options_lamella_start_position)
        ...
        self.formLayout_2.setWidget(13, QtWidgets.QFormLayout.FieldRole, self.comboBox_options_lamella_start_position)
        ...
        self.formLayout_2.setWidget(15, QtWidgets.QFormLayout.LabelRole, self.label_options_liftout_joining_method)
        ...
        self.formLayout_2.setWidget(15, QtWidgets.QFormLayout.FieldRole, self.comboBox_options_liftout_joining_method)
        ...
        self.formLayout_2.setWidget(17, QtWidgets.QFormLayout.LabelRole, self.label_options_landing_start_position)
        ...
        self.formLayout_2.setWidget(17, QtWidgets.QFormLayout.FieldRole, self.comboBox_options_landing_start_position)
        ...
        self.formLayout_2.setWidget(18, QtWidgets.QFormLayout.LabelRole, self.label_options_landing_joining_method)
        ...
        self.formLayout_2.setWidget(18, QtWidgets.QFormLayout.FieldRole, self.comboBox_options_landing_joining_method)
        ...
        self.formLayout_2.setWidget(23, QtWidgets.QFormLayout.SpanningRole, self.label_alignment_header)
        ...
        self.formLayout_2.setWidget(26, QtWidgets.QFormLayout.FieldRole, self.checkBox_align_at_milling_current)
        self.beamShiftAttemptsLabel = QtWidgets.QLabel(self.tab_2)
        self.beamShiftAttemptsLabel.setObjectName("beamShiftAttemptsLabel")
        self.formLayout_2.setWidget(27, QtWidgets.QFormLayout.LabelRole, self.beamShiftAttemptsLabel)
        self.beamshift_attempts = QtWidgets.QDoubleSpinBox(self.tab_2)
        self.beamshift_attempts.setObjectName("beamshift_attempts")
        self.formLayout_2.setWidget(27, QtWidgets.QFormLayout.FieldRole, self.beamshift_attempts)
        ...
        self.formLayout_2.setWidget(29, QtWidgets.QFormLayout.SpanningRole, self.label_ml_header)
        self.label_ml_checkpoint = QtWidgets.QLabel(self.tab_2)
        self.label_ml_checkpoint.setObjectName("label_ml_checkpoint")
        self.formLayout_2.setWidget(30, QtWidgets.QFormLayout.LabelRole, self.label_ml_checkpoint)
        self.lineEdit_ml_checkpoint = QtWidgets.QLineEdit(self.tab_2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.lineEdit_ml_checkpoint.sizePolicy().hasHeightForWidth())
        self.lineEdit_ml_checkpoint.setSizePolicy(sizePolicy)
        self.lineEdit_ml_checkpoint.setObjectName("lineEdit_ml_checkpoint")
        self.formLayout_2.setWidget(30, QtWidgets.QFormLayout.FieldRole, self.lineEdit_ml_checkpoint)
        self.label_ml_encoder = QtWidgets.QLabel(self.tab_2)
        self.label_ml_encoder.setObjectName("label_ml_encoder")
        self.formLayout_2.setWidget(31, QtWidgets.QFormLayout.LabelRole, self.label_ml_encoder)
        self.lineEdit_ml_encoder = QtWidgets.QLineEdit(self.tab_2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.lineEdit_ml_encoder.sizePolicy().hasHeightForWidth())
        self.lineEdit_ml_encoder.setSizePolicy(sizePolicy)
        self.lineEdit_ml_encoder.setObjectName("lineEdit_ml_encoder")
        self.formLayout_2.setWidget(31, QtWidgets.QFormLayout.FieldRole, self.lineEdit_ml_encoder)
        self.label_ml_num_classes = QtWidgets.QLabel(self.tab_2)
        self.label_ml_num_classes.setObjectName("label_ml_num_classes")
        self.formLayout_2.setWidget(32, QtWidgets.QFormLayout.LabelRole, self.label_ml_num_classes)
        ...
        self.formLayout_2.setWidget(32, QtWidgets.QFormLayout.FieldRole, self.spinBox_ml_num_classes)
        ...
        self.formLayout_2.setWidget(33, QtWidgets.QFormLayout.SpanningRole, self.label_supervise_header)
        self.checkBox_trench = QtWidgets.QCheckBox(self.tab_2)
        self.checkBox_trench.setObjectName("checkBox_trench")
        self.formLayout_2.setWidget(34, QtWidgets.QFormLayout.LabelRole, self.checkBox_trench)
        self.checkBox_setup = QtWidgets.QCheckBox(self.tab_2)
        self.checkBox_setup.setObjectName("checkBox_setup")
        self.formLayout_2.setWidget(34, QtWidgets.QFormLayout.FieldRole, self.checkBox_setup)
        self.checkBox_undercut = QtWidgets.QCheckBox(self.tab_2)
        self.checkBox_undercut.setObjectName("checkBox_undercut")
        self.formLayout_2.setWidget(35, QtWidgets.QFormLayout.LabelRole, self.checkBox_undercut)
        ...
        self.formLayout_2.setWidget(35, QtWidgets.QFormLayout.FieldRole, self.checkBox_supervise_mill_rough)
        ...
        self.formLayout_2.setWidget(36, QtWidgets.QFormLayout.LabelRole, self.checkBox_supervise_liftout)
        ...
        self.formLayout_2.setWidget(36, QtWidgets.QFormLayout.FieldRole, self.checkBox_supervise_mill_polishing)
        ...
        self.formLayout_2.setWidget(37, QtWidgets.QFormLayout.LabelRole, self.checkBox_supervise_landing)
        ...
        self.formLayout_2.setWidget(40, QtWidgets.QFormLayout.SpanningRole, self.pushButton_update_protocol)
        ...
        self.formLayout_2.setWidget(8, QtWidgets.QFormLayout.FieldRole, self.doubleSpinBox_undercut_step)
        ...
        self.formLayout_2.setWidget(6, QtWidgets.QFormLayout.LabelRole, self.checkBox_take_final_reference_images)
        ...
        self.formLayout_2.setWidget(6, QtWidgets.QFormLayout.FieldRole, self.checkBox_take_final_high_quality_reference)
        ...
        self.formLayout_2.setWidget(5, QtWidgets.QFormLayout.LabelRole, self.checkBox_options_confirm_next_stage)
