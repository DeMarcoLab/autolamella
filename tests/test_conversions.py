...
from lamella.mock_objects import MockAdornedImage
from lamella.conversions import (realspace_to_pixel_coordinate,
...
@pytest.mark.parametrize("coord, expected_output", [
    ([0, 0], [5, 5]),
    ([1e-6, 0], [6, 5]),
    ([0, 1e-6], [5, 4]),
    ([1e-6, 1e-6], [6, 4]),
